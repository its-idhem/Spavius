...
NOTE - To work Spavius currentely, you have to upload your own Gemini API Key, since this was made around the time of Gemini 2.5, and that model has been retired
